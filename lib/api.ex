defmodule Device.Api do
  ...
  """
  @spec create(Caller.t, uuid, non_neg_integer, non_neg_integer, %{String.t => String.t}, non_neg_integer, boolean) :: :ok | {:error, code, reason}
  def create(caller, did, data_stream_frequency, status_stream_frequency, configs, metrics, enabled \\ true) do
    remote_call(:create, [caller, did, data_stream_frequency, status_stream_frequency, configs, metrics, enabled])
  end
